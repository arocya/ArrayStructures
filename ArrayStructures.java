public class ArrayStructures {
	...
	private static int[] theSecondArray = new int[45];
	
	
	private int arraySize = 10; // Elements in theArray
	private static int secondArraySize = 20;
	...
	public void genRandomArray(int size, int []array){
	...
	public static void main(String[] args){
		...
		ArrayStructures newSecond = new ArrayStructures();
		newSecond.genRandomArray(secondArraySize, theSecondArray);
